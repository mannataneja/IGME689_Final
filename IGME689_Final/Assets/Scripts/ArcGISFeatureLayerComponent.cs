    ...
    private void CreateFeatures()
    {
        foreach (var feature in jFeatures)
        {
            ...
            foreach (var coordinate in coordinates)
            {
                ...
                GameObject point = Instantiate(prefab, transform);
                point.GetComponent<ArcGISLocationComponent>().Position = position;
                point.GetComponent<ArcGISLocationComponent>().Rotation = new ArcGISRotation(0, 90, 0);
